package com.littlerootsinc.trishapesshapes;
...
import com.littlerootsinc.trishapesshapes.Helper.CenterZoomLayoutManager;
import com.littlerootsinc.worldofshapes.R;
...
//    private AdView adView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shapesRecycler.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            @Override
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (pos>=0){
                    ...
                    shapesRecycler.smoothScrollToPosition(0);
            }
        });
    }
    ...
    public void onClick(View v) {
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), sounds[pos]);
        mediaPlayer.start();
        Toast.makeText(this, "check that", Toast.LENGTH_SHORT).show();
    }
}